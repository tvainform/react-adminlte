let store = {
    ...
    addIncident() {
        let newIncident ={
            ...
            d7:"",
            d8:"",
            d9:this._state.incidentTable.newIncidentText,
            d10:"",
        };
        this._state.incidentTable.incidentData.push(newIncident);
        this._state.incidentTable.newIncidentText = '';
        this.callSubscriber(this._state);
    },
    updateNewIncidentText(newText) {
        this._state.incidentTable.newIncidentText = newText;
        this.callSubscriber(this._state);
    },
    subscribe(observer) {
